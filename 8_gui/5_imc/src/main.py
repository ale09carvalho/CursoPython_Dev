...
def main(page: ft.Page):
    ...
    def calcular_imc(e):
        ...
        if not peso.value:
            peso.error_text = "Campo obrigatório - insira seu peso"
            page.update()
        else:
            peso.error_text = ""
            page.update()
        ...
        if not altura.value:
            altura.error_text = "Campo obrigatório - insira sua altura"
            page.update()
        else:
            altura.error_text = ""

            # se os campos estiverem preenchidos, calcula o IMC
            ...
            dlg_modal.title.value = f"O resultado do IMC é {imc:.2f}"
            ...
            # 'abre' o modal - a caixa de diálogo
            page.open(dlg_modal)

            # limpa e prepara os campos para nova entrada
            peso.value = ""
            altura.value = ""
    ...
    # conteúdo da janela - corpo da aplicação
    page.add(
        ft.SafeArea(
            ft.Container(
